...
static inline int TSListPrepend(TSList *list,void *data) { return TSListInsert(list,data,0); }
static inline int TSListAppend(TSList *list,void *data) { return TSListInsert(list,data,list->len); }
